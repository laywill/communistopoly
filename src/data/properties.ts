...
export const COLLECTIVIZATION_LEVELS = [
  ...
  { level: 1, name: "Worker's Committee", multiplier: 1.5, cost: 100 },
  { level: 2, name: 'Party Oversight', multiplier: 2.0, cost: 100 },
  { level: 3, name: 'Full Collectivization', multiplier: 2.5, cost: 100 },
  { level: 4, name: 'Model Soviet', multiplier: 3.0, cost: 100 },
  { level: 5, name: "People's Palace", multiplier: 4.0, cost: 200 }
]
